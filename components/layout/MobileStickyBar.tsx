...
export function MobileStickyBar(): React.ReactElement {
  return (
    <aside
      className="md:hidden fixed bottom-0 left-0 right-0 z-40 bg-brand-surface/95 backdrop-blur-sm border-t border-brand-border px-4 py-2.5 shadow-overlay transition-transform duration-200"
