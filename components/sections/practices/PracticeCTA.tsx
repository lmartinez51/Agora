...
export function PracticeCTA({ practice }: PracticeCTAProps): React.ReactElement {
  return (
    <section className="py-14 sm:py-20 bg-brand-primary text-white border-b border-brand-primary" aria-label={`Consulta sobre ${practice.title}`}>
      <Container size="lg">
        <div className="text-center space-y-6 max-w-3xl mx-auto">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-serif font-bold text-white tracking-tight">
            ¿Requiere representación o consultoría en {practice.title.toLowerCase()}?
          </h2>

          <p className="text-sm sm:text-base text-neutral-300 leading-relaxed max-w-2xl mx-auto">
            Comuníquese con nuestro equipo para una valoración confidencial de su caso. Evaluaremos las alternativas legales y la vía procesal adecuada.
          </p>
          ...
          <div className="pt-6 border-t border-white/15 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-neutral-400">
            <div className="flex items-center gap-2">
              <span className="font-mono text-neutral-300">Atención telefónica:</span>
