...
export function KnowledgeHero(): React.ReactElement {
  return (
    <section className="pt-8 pb-12 sm:pt-12 sm:pb-16 bg-brand-canvas border-b border-brand-border" aria-label="Introducción al Centro de Conocimiento">
      <Container size="xl">
        {/* Breadcrumb */}
        ...
        <div className="max-w-3xl space-y-5">
          <div className="flex items-center gap-2.5">
            ...
            <Badge variant="outline" size="sm">
              Publicaciones Oficiales AGORA
            </Badge>
          </div>

          <h1 className="text-3xl sm:text-4xl md:text-5xl font-serif font-bold text-brand-primary tracking-tight leading-tight">
            Centro de Conocimiento y Guías Legales
          </h1>

          <p className="text-base sm:text-lg text-brand-text-secondary leading-relaxed">
            Publicaciones técnicas, guías procesales y análisis normativos elaborados por el equipo legal de AGORA. Información clara y fundamentada sobre derechos, procedimientos y aspectos jurídicos clave en México.
          </p>
        </div>
      </Container>
    </section>
